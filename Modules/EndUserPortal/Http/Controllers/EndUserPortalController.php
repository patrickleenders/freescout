...
class EndUserPortalController extends Controller
{
    ...
    public function settings($mailbox_id)
    {
        ...
        $settings = [
            'text_submit' => $meta_settings['text_submit'] ?? \EndUserPortal::getDefaultPortalSettings()['text_submit'],
            'footer' => $meta_settings['footer'] ?? \EndUserPortal::getDefaultPortalSettings()['footer'],
            'consent' => $meta_settings['consent'] ?? \EndUserPortal::getDefaultPortalSettings()['consent'],
            'privacy' => $meta_settings['privacy'] ?? \EndUserPortal::getDefaultPortalSettings()['privacy'],
        ];
